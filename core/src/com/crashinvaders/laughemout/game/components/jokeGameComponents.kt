...
class AudienceMember(
    ...
    var cAffectionIndicator: AffectionIndicator? = null
    ...
    class AffectionIndicator(val type: Type) : EntityComponent<AffectionIndicator>() {
        override fun type() = AffectionIndicator
        companion object : ComponentType<AffectionIndicator>()

        enum class Type(val imgName: String) {
            Unknown("affection-ind-unknown")
        }
    }
}